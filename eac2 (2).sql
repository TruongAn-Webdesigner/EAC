...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2020 at 10:02 AM
...
--
-- Table structure for table `chitietdiadiem`
--
...
--
-- Table structure for table `danhsachkh`
--
...
--
-- Dumping data for table `danhsachkh`
--
...
--
-- Indexes for table `chitietdiadiem`
--
...
--
-- Constraints for table `chitietdiadiem`
--
ALTER TABLE `chitietdiadiem`
...
--
-- Constraints for table `danhsachkh`
--
ALTER TABLE `danhsachkh`
