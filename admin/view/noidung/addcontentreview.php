        ...
        <div class="boxcenter_add">
            <div class="content_form_edit">
                <div class="left_content_edit">
                    <form class="formedit" action="index.php?ctrl=tipnote&act=addnoidungtip" method='post' enctype="multipart/form-data">


                            <h1> thêm nội dung review</h1>
                        <div class="form_group">

                            

                            <div class="form_content">
                                <label for="">Ma noi dung</label>
                            ...
                            <div class="form_content">
                                <textarea name="" id="" cols="120" rows="10" value=""></textarea>
                            </div>
