...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 09, 2020 lúc 06:53 AM
...
CREATE TABLE `chitiettour` (
  ...
  `price_ct` double(10,3) DEFAULT NULL,
  `id_dd` int(11) DEFAULT NULL
...
(1, 1, 1, 1, '2020-11-20', '2020-11-21', 1499999.000, 1),
(2, 2, 1, 2, '2020-11-20', '2020-11-21', 2499999.000, 2),
(3, NULL, 2, NULL, '2020-11-25', '2020-11-26', 999999.000, 3),
(4, NULL, 2, NULL, '2020-11-25', '2020-11-26', 1599999.000, 4),
(5, NULL, 3, NULL, '2020-11-26', '2020-11-27', 3999000.000, 7);
...
INSERT INTO `diadiem` (`id_dd`, `name_dd`, `rating_dd`, `id_kv`, `img_dd`, `trangthai`) VALUES
(1, 'Bà Nà Hill', 5, 1, 'cauvang.jpg', 1),
(2, 'Cù Lao Chàm', 4, 1, '9bc1cfd89b3654e11b05beb9534a3bd8.jpg', 1),
(3, 'Nhà Thờ Đức Bà', 4, 2, 'nhathoducba.jpg', 1),
(4, 'landmark 81', 4, 2, 'landmark.jpg', 1),
(7, 'Vịnh Hạ Long', 5, 3, 'ha-long-bay-2194608__340.jpg', 1),
(9, 'thptbencat', 5, 2, 'city-4935633_1280.jpg', 0),
(11, 'công nguyễn đức', 5, 2, '128865280_696874230984587_7609783451073896243_n.png', 0);
...
--
ALTER TABLE `admin`
  MODIFY `id_ad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `diadiem`
  MODIFY `id_dd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
