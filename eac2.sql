...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 16, 2020 lúc 04:28 PM
...
--
-- Cấu trúc bảng cho bảng `booktour`
--
...
--
-- Đang đổ dữ liệu cho bảng `booktour`
--
...
(1, 1, 2, '0000-00-00', 'askdasdlajsdl'),
(2, 3, 2, '0000-00-00', 'ghe vay luon'),
(3, 3, 3, '0000-00-00', 'askdasdlajsdl'),
(10, 3, 2, '2020-12-11', '3'),
(11, 3, 2, '2020-12-11', 'xin chao cac ban'),
(12, 3, 3, '2020-12-11', 'hello'),
(13, 5, 2, '2020-12-11', 'hello'),
(15, 5, 3, '2020-12-12', 'hello'),
(16, 5, 3, '2020-12-12', 'hello');
...
(1, 'Bà Nà Hill', 1.88889, 1, 'cauvang.jpg', 0, 9, 1, '2020-12-16', '2020-12-23', 122324),
(2, 'Cù Lao Chàm', 3.76922, 1, '9bc1cfd89b3654e11b05beb9534a3bd8.jpg', 0, 13, 1, NULL, NULL, 0),
(3, 'Nhà Thờ Đức Bà', 5, 2, 'nhathoducba.jpg', 0, 1, 1, NULL, NULL, 0),
(4, 'Landmark 81', 5, 2, 'landmark.jpg', 0, 1, 1, NULL, NULL, 0),
...
(20, 'sếvsedv ưefwe', 0, 1, 'doantest.jpg', 0, NULL, 0, '2020-12-16', '2020-12-17', 122);
...
--
-- Cấu trúc bảng cho bảng `noidungtipnote`
--
...
--
-- Đang đổ dữ liệu cho bảng `noidungtipnote`
--
...
--
-- Chỉ mục cho bảng `noidungtipnote`
--
...
--
-- AUTO_INCREMENT cho bảng `booktour`
--
ALTER TABLE `booktour`
...
--
ALTER TABLE `diadiem`
  MODIFY `id_dd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `khachhang`
--
ALTER TABLE `khachhang`
  MODIFY `id_kh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `noidungbocuc`
  MODIFY `id_noidung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT cho bảng `noidungtipnote`
--
ALTER TABLE `noidungtipnote`
...
--
-- Các ràng buộc cho bảng `booktour`
--
ALTER TABLE `booktour`
...
--
-- Các ràng buộc cho bảng `noidungtipnote`
--
ALTER TABLE `noidungtipnote`
