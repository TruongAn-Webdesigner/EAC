...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 31, 2021 lúc 05:29 PM
...
(16, 'công nguyễn đức', 'duccongnguyen14102001@gmai.com', 962595677, '', '2021-01-14', 1, NULL),
(17, 'Nguyễn Đức Công', 'duccong1410@gmail.com', 962595677, '', '2021-01-14', 2, 3);
...
(19, 3, 15, '2020-12-17 17:03:25', 'đẹp'),
(20, 3, 3, '2021-01-14 13:44:02', 'xin chao cac ban');
...
(1, 'Bà Nà Hill', 1.88889, 1, 'cauvang.jpg', 8, 9, 1, '2020-12-16', '2020-12-23', 122324),
(2, 'Cù Lao Chàm', 3.76922, 1, '9bc1cfd89b3654e11b05beb9534a3bd8.jpg', 17, 13, 1, '2020-12-18', '2020-12-23', 122),
(3, 'Nhà Thờ Đức Bà', 5, 2, 'nhathoducba.jpg', 2, 1, 1, NULL, NULL, 0),
(4, 'Landmark 81', 5, 2, 'landmark.jpg', 2, 1, 1, NULL, NULL, 0),
...
(15, 'Ruộng bậc thang Mù Cang Chải', 5, 15, 'ruongbatthang.jpg', 4, 1, 1, NULL, NULL, 0),
...
(23, 'sẻtggserg', 5, 1, 'doantest2.jpg', 2, 1, 1, NULL, NULL, 0),
(24, 'ăefawef', 0, 1, 'doantest2.jpg', 0, NULL, 1, NULL, NULL, 0),
(25, 'eargearg', 0, 1, 'bongdentest.jpg', 0, NULL, 1, NULL, NULL, 0),
(26, 'thptbencat', 0, 12, 'Anonymous_Wallpaper_HD_Hinhnendl_com (1).jpg', 0, NULL, 0, NULL, NULL, 0);
...
--
ALTER TABLE `booktour`
  MODIFY `id_kh` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT cho bảng `comment`
--
ALTER TABLE `comment`
  MODIFY `id_cm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `diadiem`
--
ALTER TABLE `diadiem`
  MODIFY `id_dd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `rating`
  MODIFY `id_rt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
