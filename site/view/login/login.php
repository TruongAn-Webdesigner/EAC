...
<?php
            ...
            if(isset($_POST['DangNhap'])){
                $user=$_POST['username'];
                $pass=$_POST['password'];
                $sql = "select * from khachhang where email_kh='$user' and pass='$pass'";
                $kq = $db ->query($sql);
                $num = $kq->rowCount();
                if($num>0){
                    $_SESSION['user']=$user;
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" method="post" action="" onsubmit="return validate()">
